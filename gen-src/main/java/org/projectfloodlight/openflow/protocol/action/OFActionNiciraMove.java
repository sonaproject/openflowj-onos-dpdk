...
public interface OFActionNiciraMove extends OFObject, OFActionNicira {
    ...
    public interface Builder extends OFActionNicira.Builder {
        ...
        int getSrcOfs();
        Builder setSrcOfs(int srcOfs);
        int getDstOfs();
        Builder setDstOfs(int dstOfs);
        long getSrc();
        Builder setSrc(long src);
        long getDst();
