...
class OFActionNiciraLoadVer12 implements OFActionNiciraLoad {
...
//
    ...
    final static OFActionNiciraLoadVer12 DEFAULT = new OFActionNiciraLoadVer12(
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraLoad build() {
                ...
                //
                return new OFActionNiciraLoadVer12(
                    ofsNbits,
                    dst,
                    value
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraLoad> {
        ...
        public OFActionNiciraLoad readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraLoadVer12 actionNiciraLoadVer12 = new OFActionNiciraLoadVer12(
                    ofsNbits,
                      dst,
                      value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraLoadVer12);
    ...
    final static OFActionNiciraLoadVer12Funnel FUNNEL = new OFActionNiciraLoadVer12Funnel();
    static class OFActionNiciraLoadVer12Funnel implements Funnel<OFActionNiciraLoadVer12> {
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraLoadVer12> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraLoadVer12 message) {
            // fixed value property type = 65535
