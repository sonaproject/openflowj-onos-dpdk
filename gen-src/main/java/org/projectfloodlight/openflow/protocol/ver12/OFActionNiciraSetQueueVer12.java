...
class OFActionNiciraSetQueueVer12 implements OFActionNiciraSetQueue {
...
//
    ...
    final static OFActionNiciraSetQueueVer12 DEFAULT = new OFActionNiciraSetQueueVer12(
        DEFAULT_QUEUE_ID
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraSetQueue> {
        ...
        public OFActionNiciraSetQueue readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraSetQueueVer12 actionNiciraSetQueueVer12 = new OFActionNiciraSetQueueVer12(
                    queueId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraSetQueueVer12);
    ...
    final static OFActionNiciraSetQueueVer12Funnel FUNNEL = new OFActionNiciraSetQueueVer12Funnel();
    static class OFActionNiciraSetQueueVer12Funnel implements Funnel<OFActionNiciraSetQueueVer12> {
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraSetQueueVer12> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraSetQueueVer12 message) {
            // fixed value property type = 65535
