...
class OFOxmNshNpMaskedVer12 implements OFOxmNshNpMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmNshNpMaskedVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmNshNpMaskedVer12 DEFAULT = new OFOxmNshNpMaskedVer12(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmNshNpMaskedVer12(U8 value, U8 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmNshNpMaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmNshNpMaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U8> getCanonical() {
        if (U8.NO_MASK.equals(mask)) {
            return new OFOxmNshNpVer12(value);
    ...
    static class BuilderWithParent implements OFOxmNshNpMasked.Builder {
        final OFOxmNshNpMaskedVer12 parentMessage;
        ...
        BuilderWithParent(OFOxmNshNpMaskedVer12 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshNpMasked> {
        ...
        public OFOxmNshNpMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmNshNpMaskedVer12 oxmNshNpMaskedVer12 = new OFOxmNshNpMaskedVer12(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshNpMaskedVer12);
            return oxmNshNpMaskedVer12;
        }
    }
    ...
    final static OFOxmNshNpMaskedVer12Funnel FUNNEL = new OFOxmNshNpMaskedVer12Funnel();
    static class OFOxmNshNpMaskedVer12Funnel implements Funnel<OFOxmNshNpMaskedVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmNshNpMaskedVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x1f102L
            sink.putInt(0x1f102);
    ...
    static class Writer implements OFMessageWriter<OFOxmNshNpMaskedVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmNshNpMaskedVer12 message) {
            // fixed value property typeLen = 0x1f102L
            bb.writeInt(0x1f102);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmNshNpMaskedVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmNshNpMaskedVer12 other = (OFOxmNshNpMaskedVer12) obj;
