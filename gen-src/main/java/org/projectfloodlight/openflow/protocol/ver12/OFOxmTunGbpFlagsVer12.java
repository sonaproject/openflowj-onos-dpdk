...
class OFOxmTunGbpFlagsVer12 implements OFOxmTunGbpFlags {
...
//
    ...
    final static OFOxmTunGbpFlagsVer12 DEFAULT = new OFOxmTunGbpFlagsVer12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunGbpFlags> {
        ...
        public OFOxmTunGbpFlags readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunGbpFlagsVer12 oxmTunGbpFlagsVer12 = new OFOxmTunGbpFlagsVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunGbpFlagsVer12);
    ...
    final static OFOxmTunGbpFlagsVer12Funnel FUNNEL = new OFOxmTunGbpFlagsVer12Funnel();
    static class OFOxmTunGbpFlagsVer12Funnel implements Funnel<OFOxmTunGbpFlagsVer12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunGbpFlagsVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmTunGbpFlagsVer12 message) {
            // fixed value property typeLen = 0x14e01L
            bb.writeInt(0x14e01);
