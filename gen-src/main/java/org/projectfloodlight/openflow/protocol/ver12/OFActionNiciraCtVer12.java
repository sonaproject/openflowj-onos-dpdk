...
class OFActionNiciraCtVer12 implements OFActionNiciraCt {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraCtVer12.class);
    // version: 1.2
...
//
    ...
    final static OFActionNiciraCtVer12 DEFAULT = new OFActionNiciraCtVer12(
        DEFAULT_FLAGS, DEFAULT_ZONE_SRC, DEFAULT_ZONE, DEFAULT_RECIRC_TABLE, DEFAULT_ALG, DEFAULT_ACTIONS
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraCtVer12(int flags, long zoneSrc, int zone, short recircTable, int alg, List<OFAction> actions) {
        if(actions == null) {
            throw new NullPointerException("OFActionNiciraCtVer12: property actions cannot be null");
        }
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFActionNiciraCt.Builder {
        final OFActionNiciraCtVer12 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraCtVer12 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraCt build() {
                ...
                //
                return new OFActionNiciraCtVer12(
                    flags,
                    zoneSrc,
                    zone,
                    recircTable,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraCt> {
        ...
        public OFActionNiciraCt readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraCtVer12 actionNiciraCtVer12 = new OFActionNiciraCtVer12(
                    flags,
                      zoneSrc,
                      zone,
                      recircTable,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraCtVer12);
            return actionNiciraCtVer12;
        }
    }
    ...
    final static OFActionNiciraCtVer12Funnel FUNNEL = new OFActionNiciraCtVer12Funnel();
    static class OFActionNiciraCtVer12Funnel implements Funnel<OFActionNiciraCtVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraCtVer12 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraCtVer12> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraCtVer12 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraCtVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraCtVer12 other = (OFActionNiciraCtVer12) obj;
