...
class OFOxmTunGbpIdVer12 implements OFOxmTunGbpId {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTunGbpIdVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmTunGbpIdVer12 DEFAULT = new OFOxmTunGbpIdVer12(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTunGbpIdVer12(U16 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmTunGbpIdVer12: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmTunGbpId.Builder {
        final OFOxmTunGbpIdVer12 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U16 value;

        BuilderWithParent(OFOxmTunGbpIdVer12 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunGbpId> {
        ...
        public OFOxmTunGbpId readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunGbpIdVer12 oxmTunGbpIdVer12 = new OFOxmTunGbpIdVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunGbpIdVer12);
            return oxmTunGbpIdVer12;
        }
    }
    ...
    final static OFOxmTunGbpIdVer12Funnel FUNNEL = new OFOxmTunGbpIdVer12Funnel();
    static class OFOxmTunGbpIdVer12Funnel implements Funnel<OFOxmTunGbpIdVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmTunGbpIdVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x14c02L
            sink.putInt(0x14c02);
    ...
    static class Writer implements OFMessageWriter<OFOxmTunGbpIdVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmTunGbpIdVer12 message) {
            // fixed value property typeLen = 0x14c02L
            bb.writeInt(0x14c02);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTunGbpIdVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTunGbpIdVer12 other = (OFOxmTunGbpIdVer12) obj;
