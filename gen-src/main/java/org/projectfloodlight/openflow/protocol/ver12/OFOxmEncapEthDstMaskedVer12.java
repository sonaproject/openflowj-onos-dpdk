...
class OFOxmEncapEthDstMaskedVer12 implements OFOxmEncapEthDstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmEncapEthDstMaskedVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmEncapEthDstMaskedVer12 DEFAULT = new OFOxmEncapEthDstMaskedVer12(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmEncapEthDstMaskedVer12(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmEncapEthDstMaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmEncapEthDstMaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmEncapEthDstVer12(value);
    ...
    static class BuilderWithParent implements OFOxmEncapEthDstMasked.Builder {
        final OFOxmEncapEthDstMaskedVer12 parentMessage;
        ...
        BuilderWithParent(OFOxmEncapEthDstMaskedVer12 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEncapEthDstMasked> {
        ...
        public OFOxmEncapEthDstMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmEncapEthDstMaskedVer12 oxmEncapEthDstMaskedVer12 = new OFOxmEncapEthDstMaskedVer12(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEncapEthDstMaskedVer12);
            return oxmEncapEthDstMaskedVer12;
        }
    }
    ...
    final static OFOxmEncapEthDstMaskedVer12Funnel FUNNEL = new OFOxmEncapEthDstMaskedVer12Funnel();
    static class OFOxmEncapEthDstMaskedVer12Funnel implements Funnel<OFOxmEncapEthDstMaskedVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmEncapEthDstMaskedVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x1f50cL
            sink.putInt(0x1f50c);
    ...
    static class Writer implements OFMessageWriter<OFOxmEncapEthDstMaskedVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmEncapEthDstMaskedVer12 message) {
            // fixed value property typeLen = 0x1f50cL
            bb.writeInt(0x1f50c);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmEncapEthDstMaskedVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmEncapEthDstMaskedVer12 other = (OFOxmEncapEthDstMaskedVer12) obj;
