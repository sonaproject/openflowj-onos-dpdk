...
class OFOxmConntrackStateVer12 implements OFOxmConntrackState {
...
//
    ...
    final static OFOxmConntrackStateVer12 DEFAULT = new OFOxmConntrackStateVer12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConntrackState> {
        ...
        public OFOxmConntrackState readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConntrackStateVer12 oxmConntrackStateVer12 = new OFOxmConntrackStateVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConntrackStateVer12);
    ...
    final static OFOxmConntrackStateVer12Funnel FUNNEL = new OFOxmConntrackStateVer12Funnel();
    static class OFOxmConntrackStateVer12Funnel implements Funnel<OFOxmConntrackStateVer12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConntrackStateVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmConntrackStateVer12 message) {
            // fixed value property typeLen = 0x1d204L
            bb.writeInt(0x1d204);
