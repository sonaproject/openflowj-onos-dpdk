...
public class OFActionsVer12 implements OFActions {
    ...
    public OFActionNiciraCt.Builder buildNiciraCt() {
        return new OFActionNiciraCtVer12.Builder();
    }

    public OFActionNiciraCtClear niciraCtClear() {
        return OFActionNiciraCtClearVer12.INSTANCE;
    }

    public OFActionNiciraNat.Builder buildNiciraNat() {
        return new OFActionNiciraNatVer12.Builder();
    }
    ...
    public OFActionOfdpaPopCw ofdpaPopCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPopCw not supported in version 1.2");
    }

    public OFActionOfdpaPopL2Header ofdpaPopL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPopL2Header not supported in version 1.2");
    }

    public OFActionOfdpaPushCw ofdpaPushCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPushCw not supported in version 1.2");
    }

    public OFActionOfdpaPushL2Header ofdpaPushL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPushL2Header not supported in version 1.2");
    }

    public OFActionOfdpaSetVlanTranslation ofdpaSetVlanTranslation() {
        throw new UnsupportedOperationException("OFActionOfdpaSetVlanTranslation not supported in version 1.2");
    }

    public OFActionOnfCopyField.Builder buildOnfCopyField() {
        throw new UnsupportedOperationException("OFActionOnfCopyField not supported in version 1.2");
    }
