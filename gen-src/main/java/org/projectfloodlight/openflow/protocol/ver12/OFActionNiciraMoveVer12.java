...
class OFActionNiciraMoveVer12 implements OFActionNiciraMove {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraMoveVer12.class);
    // version: 1.2
...
//
    ...
    final static OFActionNiciraMoveVer12 DEFAULT = new OFActionNiciraMoveVer12(
        DEFAULT_N_BITS, DEFAULT_SRC_OFS, DEFAULT_DST_OFS, DEFAULT_SRC, DEFAULT_DST
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraMoveVer12(int nBits, int srcOfs, int dstOfs, long src, long dst) {
        this.nBits = nBits;
        this.srcOfs = srcOfs;
        this.dstOfs = dstOfs;
        this.src = src;
    ...
    static class BuilderWithParent implements OFActionNiciraMove.Builder {
        final OFActionNiciraMoveVer12 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraMoveVer12 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraMove build() {
                ...
                //
                return new OFActionNiciraMoveVer12(
                    nBits,
                    srcOfs,
                    dstOfs,
                    src,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraMove> {
        ...
        public OFActionNiciraMove readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraMoveVer12 actionNiciraMoveVer12 = new OFActionNiciraMoveVer12(
                    nBits,
                      srcOfs,
                      dstOfs,
                      src,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraMoveVer12);
            return actionNiciraMoveVer12;
        }
    }
    ...
    final static OFActionNiciraMoveVer12Funnel FUNNEL = new OFActionNiciraMoveVer12Funnel();
    static class OFActionNiciraMoveVer12Funnel implements Funnel<OFActionNiciraMoveVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraMoveVer12 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraMoveVer12> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraMoveVer12 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraMoveVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraMoveVer12 other = (OFActionNiciraMoveVer12) obj;
