...
class OFOxmReg6Ver12 implements OFOxmReg6 {
...
//
    ...
    final static OFOxmReg6Ver12 DEFAULT = new OFOxmReg6Ver12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmReg6> {
        ...
        public OFOxmReg6 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmReg6Ver12 oxmReg6Ver12 = new OFOxmReg6Ver12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmReg6Ver12);
            return oxmReg6Ver12;
        }
    }
    ...
    final static OFOxmReg6Ver12Funnel FUNNEL = new OFOxmReg6Ver12Funnel();
    static class OFOxmReg6Ver12Funnel implements Funnel<OFOxmReg6Ver12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmReg6Ver12> {
        @Override
        public void write(ByteBuf bb, OFOxmReg6Ver12 message) {
            // fixed value property typeLen = 0x10c04L
            bb.writeInt(0x10c04);
