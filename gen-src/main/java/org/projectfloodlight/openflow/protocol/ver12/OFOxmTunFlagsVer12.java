...
class OFOxmTunFlagsVer12 implements OFOxmTunFlags {
...
//
    ...
    final static OFOxmTunFlagsVer12 DEFAULT = new OFOxmTunFlagsVer12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunFlags> {
        ...
        public OFOxmTunFlags readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunFlagsVer12 oxmTunFlagsVer12 = new OFOxmTunFlagsVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunFlagsVer12);
    ...
    final static OFOxmTunFlagsVer12Funnel FUNNEL = new OFOxmTunFlagsVer12Funnel();
    static class OFOxmTunFlagsVer12Funnel implements Funnel<OFOxmTunFlagsVer12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunFlagsVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmTunFlagsVer12 message) {
            // fixed value property typeLen = 0x1d002L
            bb.writeInt(0x1d002);
