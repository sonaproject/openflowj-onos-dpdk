...
class OFOxmTunGpeFlagsVer12 implements OFOxmTunGpeFlags {
...
//
    ...
    final static OFOxmTunGpeFlagsVer12 DEFAULT = new OFOxmTunGpeFlagsVer12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunGpeFlags> {
        ...
        public OFOxmTunGpeFlags readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunGpeFlagsVer12 oxmTunGpeFlagsVer12 = new OFOxmTunGpeFlagsVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunGpeFlagsVer12);
    ...
    final static OFOxmTunGpeFlagsVer12Funnel FUNNEL = new OFOxmTunGpeFlagsVer12Funnel();
    static class OFOxmTunGpeFlagsVer12Funnel implements Funnel<OFOxmTunGpeFlagsVer12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunGpeFlagsVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmTunGpeFlagsVer12 message) {
            // fixed value property typeLen = 0x1e001L
            bb.writeInt(0x1e001);
