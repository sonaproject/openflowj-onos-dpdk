...
class OFActionNiciraSetQueueVer11 implements OFActionNiciraSetQueue {
...
//
    ...
    final static OFActionNiciraSetQueueVer11 DEFAULT = new OFActionNiciraSetQueueVer11(
        DEFAULT_QUEUE_ID
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraSetQueue> {
        ...
        public OFActionNiciraSetQueue readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraSetQueueVer11 actionNiciraSetQueueVer11 = new OFActionNiciraSetQueueVer11(
                    queueId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraSetQueueVer11);
    ...
    final static OFActionNiciraSetQueueVer11Funnel FUNNEL = new OFActionNiciraSetQueueVer11Funnel();
    static class OFActionNiciraSetQueueVer11Funnel implements Funnel<OFActionNiciraSetQueueVer11> {
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraSetQueueVer11> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraSetQueueVer11 message) {
            // fixed value property type = 65535
