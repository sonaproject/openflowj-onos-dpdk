...
class OFActionNiciraLoadVer11 implements OFActionNiciraLoad {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraLoadVer11.class);
    // version: 1.1
...
//
    ...
    final static OFActionNiciraLoadVer11 DEFAULT = new OFActionNiciraLoadVer11(
        DEFAULT_OFS_NBITS, DEFAULT_DST, DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraLoadVer11(int ofsNbits, long dst, U64 value) {
        if(value == null) {
            throw new NullPointerException("OFActionNiciraLoadVer11: property value cannot be null");
        }
    ...
    static class BuilderWithParent implements OFActionNiciraLoad.Builder {
        final OFActionNiciraLoadVer11 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraLoadVer11 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraLoad build() {
                ...
                //
                return new OFActionNiciraLoadVer11(
                    ofsNbits,
                    dst,
                    value
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraLoad> {
        ...
        public OFActionNiciraLoad readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraLoadVer11 actionNiciraLoadVer11 = new OFActionNiciraLoadVer11(
                    ofsNbits,
                      dst,
                      value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraLoadVer11);
            return actionNiciraLoadVer11;
        }
    }
    ...
    final static OFActionNiciraLoadVer11Funnel FUNNEL = new OFActionNiciraLoadVer11Funnel();
    static class OFActionNiciraLoadVer11Funnel implements Funnel<OFActionNiciraLoadVer11> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraLoadVer11 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraLoadVer11> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraLoadVer11 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraLoadVer11(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraLoadVer11 other = (OFActionNiciraLoadVer11) obj;
