...
public class OFActionsVer11 implements OFActions {
    ...
    public OFActionNiciraPopNsh niciraPopNsh() {
        return OFActionNiciraPopNshVer11.INSTANCE;
    }
    ...
    public OFActionNiciraPushNsh niciraPushNsh() {
        return OFActionNiciraPushNshVer11.INSTANCE;
    }
    ...
    public OFActionNiciraCt.Builder buildNiciraCt() {
        throw new UnsupportedOperationException("OFActionNiciraCt not supported in version 1.1");
    }

    public OFActionNiciraCtClear niciraCtClear() {
        throw new UnsupportedOperationException("OFActionNiciraCtClear not supported in version 1.1");
    }

    public OFActionNiciraNat.Builder buildNiciraNat() {
        throw new UnsupportedOperationException("OFActionNiciraNat not supported in version 1.1");
    }
    ...
    public OFActionOfdpaPopCw ofdpaPopCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPopCw not supported in version 1.1");
    }

    public OFActionOfdpaPopL2Header ofdpaPopL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPopL2Header not supported in version 1.1");
    }

    public OFActionOfdpaPushCw ofdpaPushCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPushCw not supported in version 1.1");
    }

    public OFActionOfdpaPushL2Header ofdpaPushL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPushL2Header not supported in version 1.1");
    }

    public OFActionOfdpaSetVlanTranslation ofdpaSetVlanTranslation() {
        throw new UnsupportedOperationException("OFActionOfdpaSetVlanTranslation not supported in version 1.1");
    }

    public OFActionOnfCopyField.Builder buildOnfCopyField() {
        throw new UnsupportedOperationException("OFActionOnfCopyField not supported in version 1.1");
    }

    public OFActionOplinkAtt.Builder buildOplinkAtt() {
        throw new UnsupportedOperationException("OFActionOplinkAtt not supported in version 1.1");
    }
