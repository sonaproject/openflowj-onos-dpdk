...
class OFActionNiciraMoveVer11 implements OFActionNiciraMove {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraMoveVer11.class);
    // version: 1.1
...
//
    ...
    final static OFActionNiciraMoveVer11 DEFAULT = new OFActionNiciraMoveVer11(
        DEFAULT_N_BITS, DEFAULT_SRC_OFS, DEFAULT_DST_OFS, DEFAULT_SRC, DEFAULT_DST
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraMoveVer11(int nBits, int srcOfs, int dstOfs, long src, long dst) {
        this.nBits = nBits;
        this.srcOfs = srcOfs;
        this.dstOfs = dstOfs;
        this.src = src;
    ...
    static class BuilderWithParent implements OFActionNiciraMove.Builder {
        final OFActionNiciraMoveVer11 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraMoveVer11 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraMove build() {
                ...
                //
                return new OFActionNiciraMoveVer11(
                    nBits,
                    srcOfs,
                    dstOfs,
                    src,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraMove> {
        ...
        public OFActionNiciraMove readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraMoveVer11 actionNiciraMoveVer11 = new OFActionNiciraMoveVer11(
                    nBits,
                      srcOfs,
                      dstOfs,
                      src,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraMoveVer11);
            return actionNiciraMoveVer11;
        }
    }
    ...
    final static OFActionNiciraMoveVer11Funnel FUNNEL = new OFActionNiciraMoveVer11Funnel();
    static class OFActionNiciraMoveVer11Funnel implements Funnel<OFActionNiciraMoveVer11> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraMoveVer11 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraMoveVer11> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraMoveVer11 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraMoveVer11(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraMoveVer11 other = (OFActionNiciraMoveVer11) obj;
