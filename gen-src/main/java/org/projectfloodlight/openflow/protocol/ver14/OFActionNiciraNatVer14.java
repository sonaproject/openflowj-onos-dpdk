...
class OFActionNiciraNatVer14 implements OFActionNiciraNat {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraNatVer14.class);
    // version: 1.4
...
//
    ...
    final static OFActionNiciraNatVer14 DEFAULT = new OFActionNiciraNatVer14(
        DEFAULT_FLAGS, DEFAULT_RANGE_PRESENT, DEFAULT_IPV4_RANGE, DEFAULT_IPV6_RANGE, DEFAULT_PORT_RANGE, DEFAULT_PAD
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraNatVer14(int flags, int rangePresent, List<IPv4Address> ipv4Range, List<IPv6Address> ipv6Range, List<U16> portRange, List<U8> pad) {
        if(ipv4Range == null) {
            throw new NullPointerException("OFActionNiciraNatVer14: property ipv4Range cannot be null");
        }
        if(ipv6Range == null) {
            throw new NullPointerException("OFActionNiciraNatVer14: property ipv6Range cannot be null");
        }
        if(portRange == null) {
            throw new NullPointerException("OFActionNiciraNatVer14: property portRange cannot be null");
        }
        if(pad == null) {
            throw new NullPointerException("OFActionNiciraNatVer14: property pad cannot be null");
        }
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFActionNiciraNat.Builder {
        final OFActionNiciraNatVer14 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraNatVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraNat build() {
                ...
                //
                return new OFActionNiciraNatVer14(
                    flags,
                    rangePresent,
                    ipv4Range,
                    ipv6Range,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraNat> {
        ...
        public OFActionNiciraNat readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraNatVer14 actionNiciraNatVer14 = new OFActionNiciraNatVer14(
                    flags,
                      rangePresent,
                      ipv4Range,
                      ipv6Range,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraNatVer14);
            return actionNiciraNatVer14;
        }
    }
    ...
    final static OFActionNiciraNatVer14Funnel FUNNEL = new OFActionNiciraNatVer14Funnel();
    static class OFActionNiciraNatVer14Funnel implements Funnel<OFActionNiciraNatVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraNatVer14 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraNatVer14> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraNatVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraNatVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraNatVer14 other = (OFActionNiciraNatVer14) obj;
