...
class OFOxmNshNpMaskedVer14 implements OFOxmNshNpMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmNshNpMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmNshNpMaskedVer14 DEFAULT = new OFOxmNshNpMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmNshNpMaskedVer14(U8 value, U8 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmNshNpMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmNshNpMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmNshNpMasked.Builder {
        final OFOxmNshNpMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmNshNpMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshNpMasked> {
        ...
        public OFOxmNshNpMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmNshNpMaskedVer14 oxmNshNpMaskedVer14 = new OFOxmNshNpMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshNpMaskedVer14);
            return oxmNshNpMaskedVer14;
        }
    }
    ...
    final static OFOxmNshNpMaskedVer14Funnel FUNNEL = new OFOxmNshNpMaskedVer14Funnel();
    static class OFOxmNshNpMaskedVer14Funnel implements Funnel<OFOxmNshNpMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmNshNpMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x1f102L
            sink.putInt(0x1f102);
    ...
    static class Writer implements OFMessageWriter<OFOxmNshNpMaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmNshNpMaskedVer14 message) {
            // fixed value property typeLen = 0x1f102L
            bb.writeInt(0x1f102);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmNshNpMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmNshNpMaskedVer14 other = (OFOxmNshNpMaskedVer14) obj;
