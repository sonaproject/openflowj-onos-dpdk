...
class OFOxmEncapEthSrcMaskedVer14 implements OFOxmEncapEthSrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmEncapEthSrcMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmEncapEthSrcMaskedVer14 DEFAULT = new OFOxmEncapEthSrcMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmEncapEthSrcMaskedVer14(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmEncapEthSrcMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmEncapEthSrcMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmEncapEthSrcVer14(value);
    ...
    static class BuilderWithParent implements OFOxmEncapEthSrcMasked.Builder {
        final OFOxmEncapEthSrcMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmEncapEthSrcMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEncapEthSrcMasked> {
        ...
        public OFOxmEncapEthSrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmEncapEthSrcMaskedVer14 oxmEncapEthSrcMaskedVer14 = new OFOxmEncapEthSrcMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEncapEthSrcMaskedVer14);
            return oxmEncapEthSrcMaskedVer14;
        }
    }
    ...
    final static OFOxmEncapEthSrcMaskedVer14Funnel FUNNEL = new OFOxmEncapEthSrcMaskedVer14Funnel();
    static class OFOxmEncapEthSrcMaskedVer14Funnel implements Funnel<OFOxmEncapEthSrcMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmEncapEthSrcMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x1f30cL
            sink.putInt(0x1f30c);
    ...
    static class Writer implements OFMessageWriter<OFOxmEncapEthSrcMaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmEncapEthSrcMaskedVer14 message) {
            // fixed value property typeLen = 0x1f30cL
            bb.writeInt(0x1f30c);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmEncapEthSrcMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmEncapEthSrcMaskedVer14 other = (OFOxmEncapEthSrcMaskedVer14) obj;
