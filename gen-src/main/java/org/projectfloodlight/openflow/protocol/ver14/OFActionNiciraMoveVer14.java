...
class OFActionNiciraMoveVer14 implements OFActionNiciraMove {
...
//
    ...
    final static OFActionNiciraMoveVer14 DEFAULT = new OFActionNiciraMoveVer14(
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraMove build() {
                ...
                //
                return new OFActionNiciraMoveVer14(
                    nBits,
                    srcOfs,
                    dstOfs,
                    src,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraMove> {
        ...
        public OFActionNiciraMove readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraMoveVer14 actionNiciraMoveVer14 = new OFActionNiciraMoveVer14(
                    nBits,
                      srcOfs,
                      dstOfs,
                      src,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraMoveVer14);
    ...
    final static OFActionNiciraMoveVer14Funnel FUNNEL = new OFActionNiciraMoveVer14Funnel();
    static class OFActionNiciraMoveVer14Funnel implements Funnel<OFActionNiciraMoveVer14> {
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraMoveVer14> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraMoveVer14 message) {
            // fixed value property type = 65535
