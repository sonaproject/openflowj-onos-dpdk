...
class OFActionNiciraMoveVer10 implements OFActionNiciraMove {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraMoveVer10.class);
    // version: 1.0
...
//
    ...
    final static OFActionNiciraMoveVer10 DEFAULT = new OFActionNiciraMoveVer10(
        DEFAULT_N_BITS, DEFAULT_SRC_OFS, DEFAULT_DST_OFS, DEFAULT_SRC, DEFAULT_DST
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraMoveVer10(int nBits, int srcOfs, int dstOfs, long src, long dst) {
        this.nBits = nBits;
        this.srcOfs = srcOfs;
        this.dstOfs = dstOfs;
        this.src = src;
    ...
    static class BuilderWithParent implements OFActionNiciraMove.Builder {
        final OFActionNiciraMoveVer10 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraMoveVer10 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraMove build() {
                ...
                //
                return new OFActionNiciraMoveVer10(
                    nBits,
                    srcOfs,
                    dstOfs,
                    src,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraMove> {
        ...
        public OFActionNiciraMove readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraMoveVer10 actionNiciraMoveVer10 = new OFActionNiciraMoveVer10(
                    nBits,
                      srcOfs,
                      dstOfs,
                      src,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraMoveVer10);
            return actionNiciraMoveVer10;
        }
    }
    ...
    final static OFActionNiciraMoveVer10Funnel FUNNEL = new OFActionNiciraMoveVer10Funnel();
    static class OFActionNiciraMoveVer10Funnel implements Funnel<OFActionNiciraMoveVer10> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraMoveVer10 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraMoveVer10> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraMoveVer10 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraMoveVer10(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraMoveVer10 other = (OFActionNiciraMoveVer10) obj;
