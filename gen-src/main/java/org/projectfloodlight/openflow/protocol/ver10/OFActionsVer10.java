...
public class OFActionsVer10 implements OFActions {
    ...
    public OFActionNiciraLoad.Builder buildNiciraLoad() {
        return new OFActionNiciraLoadVer10.Builder();
    }

    public OFActionNiciraMove.Builder buildNiciraMove() {
        return new OFActionNiciraMoveVer10.Builder();
    }

    public OFActionNiciraPopNsh niciraPopNsh() {
        return OFActionNiciraPopNshVer10.INSTANCE;
    }

    public OFActionNiciraPopQueue niciraPopQueue() {
        return OFActionNiciraPopQueueVer10.INSTANCE;
    }

    public OFActionNiciraPushNsh niciraPushNsh() {
        return OFActionNiciraPushNshVer10.INSTANCE;
    }
    ...
    public OFActionNiciraSetQueue.Builder buildNiciraSetQueue() {
        return new OFActionNiciraSetQueueVer10.Builder();
    }
    public OFActionNiciraSetQueue niciraSetQueue(long queueId) {
        return new OFActionNiciraSetQueueVer10(
                queueId
                    );
    }
    ...
    public OFActionNiciraCt.Builder buildNiciraCt() {
        throw new UnsupportedOperationException("OFActionNiciraCt not supported in version 1.0");
    }

    public OFActionNiciraCtClear niciraCtClear() {
        throw new UnsupportedOperationException("OFActionNiciraCtClear not supported in version 1.0");
    }

    public OFActionNiciraNat.Builder buildNiciraNat() {
        throw new UnsupportedOperationException("OFActionNiciraNat not supported in version 1.0");
    }
    ...
    public OFActionOfdpaPopCw ofdpaPopCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPopCw not supported in version 1.0");
    }

    public OFActionOfdpaPopL2Header ofdpaPopL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPopL2Header not supported in version 1.0");
    }

    public OFActionOfdpaPushCw ofdpaPushCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPushCw not supported in version 1.0");
    }

    public OFActionOfdpaPushL2Header ofdpaPushL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPushL2Header not supported in version 1.0");
    }

    public OFActionOfdpaSetVlanTranslation ofdpaSetVlanTranslation() {
        throw new UnsupportedOperationException("OFActionOfdpaSetVlanTranslation not supported in version 1.0");
    }

    public OFActionOnfCopyField.Builder buildOnfCopyField() {
        throw new UnsupportedOperationException("OFActionOnfCopyField not supported in version 1.0");
    }

    public OFActionOplinkAtt.Builder buildOplinkAtt() {
        throw new UnsupportedOperationException("OFActionOplinkAtt not supported in version 1.0");
    }
