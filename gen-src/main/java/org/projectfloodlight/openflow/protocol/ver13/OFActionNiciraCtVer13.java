...
class OFActionNiciraCtVer13 implements OFActionNiciraCt {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraCtVer13.class);
    // version: 1.3
...
//
    ...
    final static OFActionNiciraCtVer13 DEFAULT = new OFActionNiciraCtVer13(
        DEFAULT_FLAGS, DEFAULT_ZONE_SRC, DEFAULT_ZONE, DEFAULT_RECIRC_TABLE, DEFAULT_ALG, DEFAULT_ACTIONS
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraCtVer13(int flags, long zoneSrc, int zone, short recircTable, int alg, List<OFAction> actions) {
        if(actions == null) {
            throw new NullPointerException("OFActionNiciraCtVer13: property actions cannot be null");
        }
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFActionNiciraCt.Builder {
        final OFActionNiciraCtVer13 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraCtVer13 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraCt build() {
                ...
                //
                return new OFActionNiciraCtVer13(
                    flags,
                    zoneSrc,
                    zone,
                    recircTable,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraCt> {
        ...
        public OFActionNiciraCt readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraCtVer13 actionNiciraCtVer13 = new OFActionNiciraCtVer13(
                    flags,
                      zoneSrc,
                      zone,
                      recircTable,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraCtVer13);
            return actionNiciraCtVer13;
        }
    }
    ...
    final static OFActionNiciraCtVer13Funnel FUNNEL = new OFActionNiciraCtVer13Funnel();
    static class OFActionNiciraCtVer13Funnel implements Funnel<OFActionNiciraCtVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraCtVer13 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraCtVer13> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraCtVer13 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraCtVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraCtVer13 other = (OFActionNiciraCtVer13) obj;
