...
class OFOxmReg5MaskedVer13 implements OFOxmReg5Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmReg5MaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmReg5MaskedVer13 DEFAULT = new OFOxmReg5MaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmReg5MaskedVer13(U32 value, U32 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmReg5MaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmReg5MaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U32> getCanonical() {
        if (U32.NO_MASK.equals(mask)) {
            return new OFOxmReg5Ver13(value);
    ...
    static class BuilderWithParent implements OFOxmReg5Masked.Builder {
        final OFOxmReg5MaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmReg5MaskedVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmReg5Masked> {
        ...
        public OFOxmReg5Masked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmReg5MaskedVer13 oxmReg5MaskedVer13 = new OFOxmReg5MaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmReg5MaskedVer13);
            return oxmReg5MaskedVer13;
        }
    }
    ...
    final static OFOxmReg5MaskedVer13Funnel FUNNEL = new OFOxmReg5MaskedVer13Funnel();
    static class OFOxmReg5MaskedVer13Funnel implements Funnel<OFOxmReg5MaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmReg5MaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x10b08L
            sink.putInt(0x10b08);
    ...
    static class Writer implements OFMessageWriter<OFOxmReg5MaskedVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmReg5MaskedVer13 message) {
            // fixed value property typeLen = 0x10b08L
            bb.writeInt(0x10b08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmReg5MaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmReg5MaskedVer13 other = (OFOxmReg5MaskedVer13) obj;
