...
class OFOxmNshMdtypeVer13 implements OFOxmNshMdtype {
...
//
    ...
    final static OFOxmNshMdtypeVer13 DEFAULT = new OFOxmNshMdtypeVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshMdtype> {
        ...
        public OFOxmNshMdtype readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmNshMdtypeVer13 oxmNshMdtypeVer13 = new OFOxmNshMdtypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshMdtypeVer13);
    ...
    final static OFOxmNshMdtypeVer13Funnel FUNNEL = new OFOxmNshMdtypeVer13Funnel();
    static class OFOxmNshMdtypeVer13Funnel implements Funnel<OFOxmNshMdtypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmNshMdtypeVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmNshMdtypeVer13 message) {
            // fixed value property typeLen = 0x1ee01L
            bb.writeInt(0x1ee01);
