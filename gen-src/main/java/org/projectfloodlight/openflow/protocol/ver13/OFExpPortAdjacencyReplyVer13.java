...
class OFExpPortAdjacencyReplyVer13 implements OFExpPortAdjacencyReply {
    ...
    final static int MINIMUM_LENGTH = 24;
        ...
        private final static List<OFExpPortAdjacency> DEFAULT_ENTRIES = ImmutableList.<OFExpPortAdjacency>of();
...
//
    ...
    final static OFExpPortAdjacencyReplyVer13 DEFAULT = new OFExpPortAdjacencyReplyVer13(
    ...
    static class BuilderWithParent implements OFExpPortAdjacencyReply.Builder {
    ...
    public OFExpPortAdjacencyReply.Builder setEntries(List<OFExpPortAdjacency> entries) {
        ...
        public OFExpPortAdjacencyReply build() {
                ...
                List<OFExpPortAdjacency> entries = this.entriesSet ? this.entries : parentMessage.entries;
                if(entries == null)
                    throw new NullPointerException("Property entries must not be null");

                //
                return new OFExpPortAdjacencyReplyVer13(
                    xid,
                    flags,
                    entries
                );
    ...
    static class Builder implements OFExpPortAdjacencyReply.Builder {
        // OF message fields
        private boolean xidSet;
        private long xid;
        private boolean flagsSet;
...
//
        ...
        public OFExpPortAdjacencyReply build() {
            ...
            if(flags == null)
                throw new NullPointerException("Property flags must not be null");
            List<OFExpPortAdjacency> entries = this.entriesSet ? this.entries : DEFAULT_ENTRIES;
            if(entries == null)
                throw new NullPointerException("Property entries must not be null");
    ...
    static class Reader implements OFMessageReader<OFExpPortAdjacencyReply> {
        @Override
        public OFExpPortAdjacencyReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFExpPortAdjacencyReplyVer13 expPortAdjacencyReplyVer13 = new OFExpPortAdjacencyReplyVer13(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", expPortAdjacencyReplyVer13);
    ...
    final static OFExpPortAdjacencyReplyVer13Funnel FUNNEL = new OFExpPortAdjacencyReplyVer13Funnel();
    static class OFExpPortAdjacencyReplyVer13Funnel implements Funnel<OFExpPortAdjacencyReplyVer13> {
    ...
    static class Writer implements OFMessageWriter<OFExpPortAdjacencyReplyVer13> {
        @Override
        public void write(ByteBuf bb, OFExpPortAdjacencyReplyVer13 message) {
