...
class OFOxmConntrackMarkMaskedVer13 implements OFOxmConntrackMarkMasked {
...
//
    ...
    final static OFOxmConntrackMarkMaskedVer13 DEFAULT = new OFOxmConntrackMarkMaskedVer13(
    ...
    public OFOxm<U32> getCanonical() {
        if (U32.NO_MASK.equals(mask)) {
            return new OFOxmConntrackMarkVer13(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConntrackMarkMasked> {
        ...
        public OFOxmConntrackMarkMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConntrackMarkMaskedVer13 oxmConntrackMarkMaskedVer13 = new OFOxmConntrackMarkMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConntrackMarkMaskedVer13);
    ...
    final static OFOxmConntrackMarkMaskedVer13Funnel FUNNEL = new OFOxmConntrackMarkMaskedVer13Funnel();
    static class OFOxmConntrackMarkMaskedVer13Funnel implements Funnel<OFOxmConntrackMarkMaskedVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConntrackMarkMaskedVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmConntrackMarkMaskedVer13 message) {
            // fixed value property typeLen = 0x1d708L
            bb.writeInt(0x1d708);
