...
class OFOxmNshC4Ver13 implements OFOxmNshC4 {
...
//
    ...
    final static OFOxmNshC4Ver13 DEFAULT = new OFOxmNshC4Ver13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshC4> {
        ...
        public OFOxmNshC4 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmNshC4Ver13 oxmNshC4Ver13 = new OFOxmNshC4Ver13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshC4Ver13);
    ...
    final static OFOxmNshC4Ver13Funnel FUNNEL = new OFOxmNshC4Ver13Funnel();
    static class OFOxmNshC4Ver13Funnel implements Funnel<OFOxmNshC4Ver13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmNshC4Ver13> {
        @Override
        public void write(ByteBuf bb, OFOxmNshC4Ver13 message) {
            // fixed value property typeLen = 0x1ec04L
            bb.writeInt(0x1ec04);
