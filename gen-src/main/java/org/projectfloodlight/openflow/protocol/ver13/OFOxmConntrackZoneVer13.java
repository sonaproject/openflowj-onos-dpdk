...
class OFOxmConntrackZoneVer13 implements OFOxmConntrackZone {
...
//
    ...
    final static OFOxmConntrackZoneVer13 DEFAULT = new OFOxmConntrackZoneVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmConntrackZone> {
        ...
        public OFOxmConntrackZone readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmConntrackZoneVer13 oxmConntrackZoneVer13 = new OFOxmConntrackZoneVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmConntrackZoneVer13);
    ...
    final static OFOxmConntrackZoneVer13Funnel FUNNEL = new OFOxmConntrackZoneVer13Funnel();
    static class OFOxmConntrackZoneVer13Funnel implements Funnel<OFOxmConntrackZoneVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmConntrackZoneVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmConntrackZoneVer13 message) {
            // fixed value property typeLen = 0x1d402L
            bb.writeInt(0x1d402);
