...
class OFOxmNsiVer13 implements OFOxmNsi {
...
//
    ...
    final static OFOxmNsiVer13 DEFAULT = new OFOxmNsiVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNsi> {
        ...
        public OFOxmNsi readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmNsiVer13 oxmNsiVer13 = new OFOxmNsiVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNsiVer13);
            return oxmNsiVer13;
        }
    }
    ...
    final static OFOxmNsiVer13Funnel FUNNEL = new OFOxmNsiVer13Funnel();
    static class OFOxmNsiVer13Funnel implements Funnel<OFOxmNsiVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmNsiVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmNsiVer13 message) {
            // fixed value property typeLen = 0x1e401L
            bb.writeInt(0x1e401);
