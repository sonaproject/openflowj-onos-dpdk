...
class OFOxmEncapEthSrcMaskedVer13 implements OFOxmEncapEthSrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmEncapEthSrcMaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmEncapEthSrcMaskedVer13 DEFAULT = new OFOxmEncapEthSrcMaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmEncapEthSrcMaskedVer13(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmEncapEthSrcMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmEncapEthSrcMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmEncapEthSrcVer13(value);
    ...
    static class BuilderWithParent implements OFOxmEncapEthSrcMasked.Builder {
        final OFOxmEncapEthSrcMaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmEncapEthSrcMaskedVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEncapEthSrcMasked> {
        ...
        public OFOxmEncapEthSrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmEncapEthSrcMaskedVer13 oxmEncapEthSrcMaskedVer13 = new OFOxmEncapEthSrcMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEncapEthSrcMaskedVer13);
            return oxmEncapEthSrcMaskedVer13;
        }
    }
    ...
    final static OFOxmEncapEthSrcMaskedVer13Funnel FUNNEL = new OFOxmEncapEthSrcMaskedVer13Funnel();
    static class OFOxmEncapEthSrcMaskedVer13Funnel implements Funnel<OFOxmEncapEthSrcMaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmEncapEthSrcMaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x1f30cL
            sink.putInt(0x1f30c);
    ...
    static class Writer implements OFMessageWriter<OFOxmEncapEthSrcMaskedVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmEncapEthSrcMaskedVer13 message) {
            // fixed value property typeLen = 0x1f30cL
            bb.writeInt(0x1f30c);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmEncapEthSrcMaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmEncapEthSrcMaskedVer13 other = (OFOxmEncapEthSrcMaskedVer13) obj;
