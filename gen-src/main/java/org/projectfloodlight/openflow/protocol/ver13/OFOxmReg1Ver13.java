...
class OFOxmReg1Ver13 implements OFOxmReg1 {
...
//
    ...
    final static OFOxmReg1Ver13 DEFAULT = new OFOxmReg1Ver13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmReg1> {
        ...
        public OFOxmReg1 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmReg1Ver13 oxmReg1Ver13 = new OFOxmReg1Ver13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmReg1Ver13);
            return oxmReg1Ver13;
        }
    }
    ...
    final static OFOxmReg1Ver13Funnel FUNNEL = new OFOxmReg1Ver13Funnel();
    static class OFOxmReg1Ver13Funnel implements Funnel<OFOxmReg1Ver13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmReg1Ver13> {
        @Override
        public void write(ByteBuf bb, OFOxmReg1Ver13 message) {
            // fixed value property typeLen = 0x10204L
            bb.writeInt(0x10204);
