...
class OFActionNiciraLoadVer13 implements OFActionNiciraLoad {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraLoadVer13.class);
    // version: 1.3
...
//
    ...
    final static OFActionNiciraLoadVer13 DEFAULT = new OFActionNiciraLoadVer13(
        DEFAULT_OFS_NBITS, DEFAULT_DST, DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraLoadVer13(int ofsNbits, long dst, U64 value) {
        if(value == null) {
            throw new NullPointerException("OFActionNiciraLoadVer13: property value cannot be null");
        }
    ...
    static class BuilderWithParent implements OFActionNiciraLoad.Builder {
        final OFActionNiciraLoadVer13 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraLoadVer13 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraLoad build() {
                ...
                //
                return new OFActionNiciraLoadVer13(
                    ofsNbits,
                    dst,
                    value
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraLoad> {
        ...
        public OFActionNiciraLoad readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraLoadVer13 actionNiciraLoadVer13 = new OFActionNiciraLoadVer13(
                    ofsNbits,
                      dst,
                      value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraLoadVer13);
            return actionNiciraLoadVer13;
        }
    }
    ...
    final static OFActionNiciraLoadVer13Funnel FUNNEL = new OFActionNiciraLoadVer13Funnel();
    static class OFActionNiciraLoadVer13Funnel implements Funnel<OFActionNiciraLoadVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraLoadVer13 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraLoadVer13> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraLoadVer13 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraLoadVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraLoadVer13 other = (OFActionNiciraLoadVer13) obj;
