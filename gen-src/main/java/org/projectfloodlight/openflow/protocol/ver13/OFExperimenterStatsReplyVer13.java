    ...
    static class Reader implements OFMessageReader<OFExperimenterStatsReply> {
        ...
        public OFExperimenterStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               ...
               case (int) 0xff000007:
                   // discriminator value 0xff000007L=0xff000007L for class OFExpOpticalExtReplyVer13
                   return OFExpOpticalExtReplyVer13.READER.readFrom(bb);
               case (int) 0xff000088:
                   // discriminator value 0xff000088L=0xff000088L for class OFOplinkStatsReplyVer13
                   return OFOplinkStatsReplyVer13.READER.readFrom(bb);
               default:
