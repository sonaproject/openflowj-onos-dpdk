...
abstract class OFOplinkStatsReplyVer13 {
    ...
    public final static OFOplinkStatsReplyVer13.Reader READER = new Reader();

    static class Reader implements OFMessageReader<OFOplinkStatsReply> {
        @Override
        public OFOplinkStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(subtype) {
               case 0x15:
                   // discriminator value 0x15L=0x15L for class OFOplinkChannelPowerReplyVer13
                   return OFOplinkChannelPowerReplyVer13.READER.readFrom(bb);
               case 0x14:
                   // discriminator value 0x14L=0x14L for class OFOplinkPortPowerReplyVer13
