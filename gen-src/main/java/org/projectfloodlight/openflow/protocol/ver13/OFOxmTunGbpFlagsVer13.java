...
class OFOxmTunGbpFlagsVer13 implements OFOxmTunGbpFlags {
...
//
    ...
    final static OFOxmTunGbpFlagsVer13 DEFAULT = new OFOxmTunGbpFlagsVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunGbpFlags> {
        ...
        public OFOxmTunGbpFlags readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmTunGbpFlagsVer13 oxmTunGbpFlagsVer13 = new OFOxmTunGbpFlagsVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunGbpFlagsVer13);
    ...
    final static OFOxmTunGbpFlagsVer13Funnel FUNNEL = new OFOxmTunGbpFlagsVer13Funnel();
    static class OFOxmTunGbpFlagsVer13Funnel implements Funnel<OFOxmTunGbpFlagsVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunGbpFlagsVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmTunGbpFlagsVer13 message) {
            // fixed value property typeLen = 0x14e01L
            bb.writeInt(0x14e01);
