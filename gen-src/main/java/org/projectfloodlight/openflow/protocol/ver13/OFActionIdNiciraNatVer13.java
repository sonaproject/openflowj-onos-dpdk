...
class OFActionIdNiciraNatVer13 implements OFActionIdNiciraNat {
...
//
    ...
    final static OFActionIdNiciraNatVer13 DEFAULT = new OFActionIdNiciraNatVer13(

    );

    final static OFActionIdNiciraNatVer13 INSTANCE = new OFActionIdNiciraNatVer13();
    ...
    final static OFActionIdNiciraNatVer13Funnel FUNNEL = new OFActionIdNiciraNatVer13Funnel();
    static class OFActionIdNiciraNatVer13Funnel implements Funnel<OFActionIdNiciraNatVer13> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdNiciraNatVer13> {
        @Override
        public void write(ByteBuf bb, OFActionIdNiciraNatVer13 message) {
            // fixed value property type = 65535
