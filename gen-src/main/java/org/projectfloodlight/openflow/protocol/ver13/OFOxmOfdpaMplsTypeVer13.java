...
class OFOxmOfdpaMplsTypeVer13 implements OFOxmOfdpaMplsType {
...
//
    ...
    final static OFOxmOfdpaMplsTypeVer13 DEFAULT = new OFOxmOfdpaMplsTypeVer13(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFOxmOfdpaMplsType.Builder {
    ...
    static class Builder implements OFOxmOfdpaMplsType.Builder {
        // OF message fields
        private boolean valueSet;
        private U16 value;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmOfdpaMplsType> {
        @Override
        public OFOxmOfdpaMplsType readFrom(ByteBuf bb) throws OFParseError {
            // fixed value property typeLen == 0xffff2e06L
            int typeLen = bb.readInt();
            if(typeLen != (int) 0xffff2e06)
            ...
            OFOxmOfdpaMplsTypeVer13 oxmOfdpaMplsTypeVer13 = new OFOxmOfdpaMplsTypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmOfdpaMplsTypeVer13);
    ...
    final static OFOxmOfdpaMplsTypeVer13Funnel FUNNEL = new OFOxmOfdpaMplsTypeVer13Funnel();
    static class OFOxmOfdpaMplsTypeVer13Funnel implements Funnel<OFOxmOfdpaMplsTypeVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmOfdpaMplsTypeVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0xffff2e06L
            sink.putInt((int) 0xffff2e06);
            // fixed value property experimenterId = 0x1018L
            sink.putInt(0x1018);
    ...
    static class Writer implements OFMessageWriter<OFOxmOfdpaMplsTypeVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmOfdpaMplsTypeVer13 message) {
            // fixed value property typeLen = 0xffff2e06L
            bb.writeInt((int) 0xffff2e06);
            // fixed value property experimenterId = 0x1018L
            bb.writeInt(0x1018);
