    ...
    static class Reader implements OFMessageReader<OFActionExperimenter> {
        ...
        public OFActionExperimenter readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               ...
               case 0x1018:
                   // discriminator value 0x1018L=0x1018L for class OFActionOfdpaVer13
                   return OFActionOfdpaVer13.READER.readFrom(bb);
               case 0x4f4e4600:
                   // discriminator value 0x4f4e4600L=0x4f4e4600L for class OFActionOnfVer13
                   return OFActionOnfVer13.READER.readFrom(bb);
               case (int) 0xff000088:
                   // discriminator value 0xff000088L=0xff000088L for class OFActionOplinkAttVer13
