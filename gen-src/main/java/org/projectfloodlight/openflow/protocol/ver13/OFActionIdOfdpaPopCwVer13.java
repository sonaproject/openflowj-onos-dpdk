...
class OFActionIdOfdpaPopCwVer13 implements OFActionIdOfdpaPopCw {
...
//
    ...
    final static OFActionIdOfdpaPopCwVer13 DEFAULT = new OFActionIdOfdpaPopCwVer13(

    );

    final static OFActionIdOfdpaPopCwVer13 INSTANCE = new OFActionIdOfdpaPopCwVer13();
    ...
    static class Reader implements OFMessageReader<OFActionIdOfdpaPopCw> {
        @Override
        public OFActionIdOfdpaPopCw readFrom(ByteBuf bb) throws OFParseError {
    ...
    final static OFActionIdOfdpaPopCwVer13Funnel FUNNEL = new OFActionIdOfdpaPopCwVer13Funnel();
    static class OFActionIdOfdpaPopCwVer13Funnel implements Funnel<OFActionIdOfdpaPopCwVer13> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdOfdpaPopCwVer13> {
        @Override
        public void write(ByteBuf bb, OFActionIdOfdpaPopCwVer13 message) {
            // fixed value property type = 65535
