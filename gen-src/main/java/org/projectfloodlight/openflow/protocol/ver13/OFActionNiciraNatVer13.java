...
class OFActionNiciraNatVer13 implements OFActionNiciraNat {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraNatVer13.class);
    // version: 1.3
...
//
    ...
    final static OFActionNiciraNatVer13 DEFAULT = new OFActionNiciraNatVer13(
        DEFAULT_FLAGS, DEFAULT_RANGE_PRESENT, DEFAULT_IPV4_RANGE, DEFAULT_IPV6_RANGE, DEFAULT_PORT_RANGE, DEFAULT_PAD
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraNatVer13(int flags, int rangePresent, List<IPv4Address> ipv4Range, List<IPv6Address> ipv6Range, List<U16> portRange, List<U8> pad) {
        if(ipv4Range == null) {
            throw new NullPointerException("OFActionNiciraNatVer13: property ipv4Range cannot be null");
        }
        if(ipv6Range == null) {
            throw new NullPointerException("OFActionNiciraNatVer13: property ipv6Range cannot be null");
        }
        if(portRange == null) {
            throw new NullPointerException("OFActionNiciraNatVer13: property portRange cannot be null");
        }
        if(pad == null) {
            throw new NullPointerException("OFActionNiciraNatVer13: property pad cannot be null");
        }
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFActionNiciraNat.Builder {
        final OFActionNiciraNatVer13 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraNatVer13 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraNat build() {
                ...
                //
                return new OFActionNiciraNatVer13(
                    flags,
                    rangePresent,
                    ipv4Range,
                    ipv6Range,
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraNat> {
        ...
        public OFActionNiciraNat readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraNatVer13 actionNiciraNatVer13 = new OFActionNiciraNatVer13(
                    flags,
                      rangePresent,
                      ipv4Range,
                      ipv6Range,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraNatVer13);
            return actionNiciraNatVer13;
        }
    }
    ...
    final static OFActionNiciraNatVer13Funnel FUNNEL = new OFActionNiciraNatVer13Funnel();
    static class OFActionNiciraNatVer13Funnel implements Funnel<OFActionNiciraNatVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraNatVer13 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraNatVer13> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraNatVer13 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraNatVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraNatVer13 other = (OFActionNiciraNatVer13) obj;
