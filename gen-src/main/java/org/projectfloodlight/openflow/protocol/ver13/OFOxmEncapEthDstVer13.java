...
class OFOxmEncapEthDstVer13 implements OFOxmEncapEthDst {
...
//
    ...
    final static OFOxmEncapEthDstVer13 DEFAULT = new OFOxmEncapEthDstVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEncapEthDst> {
        ...
        public OFOxmEncapEthDst readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmEncapEthDstVer13 oxmEncapEthDstVer13 = new OFOxmEncapEthDstVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEncapEthDstVer13);
    ...
    final static OFOxmEncapEthDstVer13Funnel FUNNEL = new OFOxmEncapEthDstVer13Funnel();
    static class OFOxmEncapEthDstVer13Funnel implements Funnel<OFOxmEncapEthDstVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmEncapEthDstVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmEncapEthDstVer13 message) {
            // fixed value property typeLen = 0x1f406L
            bb.writeInt(0x1f406);
