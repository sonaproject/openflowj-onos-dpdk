...
class OFOxmExpOduSigtypeVer13 implements OFOxmExpOduSigtype {
...
//
    ...
    final static OFOxmExpOduSigtypeVer13 DEFAULT = new OFOxmExpOduSigtypeVer13(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFOxmExpOduSigtype.Builder {
    ...
    static class Builder implements OFOxmExpOduSigtype.Builder {
        // OF message fields
        private boolean valueSet;
        private U8 value;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmExpOduSigtype> {
        @Override
        public OFOxmExpOduSigtype readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmExpOduSigtypeVer13 oxmExpOduSigtypeVer13 = new OFOxmExpOduSigtypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmExpOduSigtypeVer13);
    ...
    final static OFOxmExpOduSigtypeVer13Funnel FUNNEL = new OFOxmExpOduSigtypeVer13Funnel();
    static class OFOxmExpOduSigtypeVer13Funnel implements Funnel<OFOxmExpOduSigtypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmExpOduSigtypeVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmExpOduSigtypeVer13 message) {
            // fixed value property typeLen = 0xffff0401L
