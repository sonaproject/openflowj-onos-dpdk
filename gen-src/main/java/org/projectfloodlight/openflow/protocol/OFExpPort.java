...
public interface OFExpPort extends OFObject {
    OFPort getPortNo();
    MacAddress getHwAddr();
    String getName();
    Set<OFPortConfig> getConfig();
    Set<OFPortState> getState();
    List<OFExpPortDescPropOpticalTransport> getProperties();
    ...
    public interface Builder  {
        ...
        List<OFExpPortDescPropOpticalTransport> getProperties();
        Builder setProperties(List<OFExpPortDescPropOpticalTransport> properties);
        OFVersion getVersion();
    }
}
