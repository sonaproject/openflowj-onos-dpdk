...
public interface OFFactory extends XidGenerator {
    ...
    OFCalientPortStatus.Builder buildCalientPortStatus() throws UnsupportedOperationException;
    ...
    OFExpExtAdidSonet.Builder buildExpExtAdidSonet() throws UnsupportedOperationException;
    OFExpExtAdidSonet expExtAdidSonet(int type, OFBitMask128 id);
    OFExpPort.Builder buildExpPort() throws UnsupportedOperationException;
    OFExpPortAdidOtn.Builder buildExpPortAdidOtn() throws UnsupportedOperationException;
    OFExpPortAdjacency.Builder buildExpPortAdjacency() throws UnsupportedOperationException;
    OFExpPortAdjacencyId.Builder buildExpPortAdjacencyId() throws UnsupportedOperationException;
    OFExpPortAdjacencyId expPortAdjacencyId(List<OFExpExtAdId> adId);
    OFExpPortAdjacencyReply.Builder buildExpPortAdjacencyReply() throws UnsupportedOperationException;
    OFExpPortAdjacencyRequest.Builder buildExpPortAdjacencyRequest() throws UnsupportedOperationException;
    OFExpPortAdjacencyRequest expPortAdjacencyRequest(Set<OFStatsRequestFlags> flags);
    OFExpPortDesPropHeader expPortDesPropHeader();
    OFExpPortDescPropOpticalTransport.Builder buildExpPortDescPropOpticalTransport() throws UnsupportedOperationException;
    OFExpPortDescReply.Builder buildExpPortDescReply() throws UnsupportedOperationException;
    OFExpPortDescRequest.Builder buildExpPortDescRequest() throws UnsupportedOperationException;
    OFExpPortDescRequest expPortDescRequest(Set<OFStatsRequestFlags> flags);
    OFExpPortOpticalTransportLayerEntry.Builder buildExpPortOpticalTransportLayerEntry() throws UnsupportedOperationException;
    OFExpPortOpticalTransportLayerStack.Builder buildExpPortOpticalTransportLayerStack() throws UnsupportedOperationException;
    OFExpPortOpticalTransportLayerStack expPortOpticalTransportLayerStack(List<OFExpPortOpticalTransportLayerEntry> value);
    ...
    OFOduSigIdT.Builder buildOduSigIdT() throws UnsupportedOperationException;
    OFOduSigIdT oduSigIdT(int tpn, byte[] tsmap);
    OFOplinkChannelPower.Builder buildOplinkChannelPower() throws UnsupportedOperationException;
    OFOplinkChannelPowerReply.Builder buildOplinkChannelPowerReply() throws UnsupportedOperationException;
    OFOplinkChannelPowerRequest.Builder buildOplinkChannelPowerRequest() throws UnsupportedOperationException;
    OFOplinkChannelPowerRequest oplinkChannelPowerRequest(Set<OFStatsRequestFlags> flags);
    OFOplinkPortPower.Builder buildOplinkPortPower() throws UnsupportedOperationException;
    OFOplinkPortPower oplinkPortPower(int port, int powerValue);
    OFOplinkPortPowerReply.Builder buildOplinkPortPowerReply() throws UnsupportedOperationException;
    OFOplinkPortPowerRequest.Builder buildOplinkPortPowerRequest() throws UnsupportedOperationException;
    OFOplinkPortPowerRequest oplinkPortPowerRequest(Set<OFStatsRequestFlags> flags);
    OFOplinkPortPowerSet.Builder buildOplinkPortPowerSet() throws UnsupportedOperationException;
