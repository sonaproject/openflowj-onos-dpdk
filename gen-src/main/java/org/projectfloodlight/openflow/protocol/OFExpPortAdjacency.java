...
public interface OFExpPortAdjacency extends OFObject {
    OFPort getPortNo();
    MacAddress getHwAddr();
    String getName();
    Set<OFPortConfig> getConfig();
    Set<OFPortState> getState();
    List<OFExpPortAdjacencyId> getProperties();
    ...
    public interface Builder  {
        ...
        List<OFExpPortAdjacencyId> getProperties();
        Builder setProperties(List<OFExpPortAdjacencyId> properties);
        OFVersion getVersion();
    }
}
