...
class OFActionNiciraLoadVer15 implements OFActionNiciraLoad {
    private static final Logger logger = LoggerFactory.getLogger(OFActionNiciraLoadVer15.class);
    // version: 1.5
...
//
    ...
    final static OFActionNiciraLoadVer15 DEFAULT = new OFActionNiciraLoadVer15(
        DEFAULT_OFS_NBITS, DEFAULT_DST, DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFActionNiciraLoadVer15(int ofsNbits, long dst, U64 value) {
        if(value == null) {
            throw new NullPointerException("OFActionNiciraLoadVer15: property value cannot be null");
        }
    ...
    static class BuilderWithParent implements OFActionNiciraLoad.Builder {
        final OFActionNiciraLoadVer15 parentMessage;
        ...
        BuilderWithParent(OFActionNiciraLoadVer15 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraLoad build() {
                ...
                //
                return new OFActionNiciraLoadVer15(
                    ofsNbits,
                    dst,
                    value
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraLoad> {
        ...
        public OFActionNiciraLoad readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFActionNiciraLoadVer15 actionNiciraLoadVer15 = new OFActionNiciraLoadVer15(
                    ofsNbits,
                      dst,
                      value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraLoadVer15);
            return actionNiciraLoadVer15;
        }
    }
    ...
    final static OFActionNiciraLoadVer15Funnel FUNNEL = new OFActionNiciraLoadVer15Funnel();
    static class OFActionNiciraLoadVer15Funnel implements Funnel<OFActionNiciraLoadVer15> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionNiciraLoadVer15 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraLoadVer15> {
        @Override
        public void write(ByteBuf bb, OFActionNiciraLoadVer15 message) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionNiciraLoadVer15(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionNiciraLoadVer15 other = (OFActionNiciraLoadVer15) obj;
