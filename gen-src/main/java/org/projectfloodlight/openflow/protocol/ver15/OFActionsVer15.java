...
public class OFActionsVer15 implements OFActions {
    ...
    public OFActionNiciraLoad.Builder buildNiciraLoad() {
        return new OFActionNiciraLoadVer15.Builder();
    }

    public OFActionNiciraMove.Builder buildNiciraMove() {
        return new OFActionNiciraMoveVer15.Builder();
    }

    public OFActionNiciraPopNsh niciraPopNsh() {
        return OFActionNiciraPopNshVer15.INSTANCE;
    }

    public OFActionNiciraPopQueue niciraPopQueue() {
        return OFActionNiciraPopQueueVer15.INSTANCE;
    }

    public OFActionNiciraPushNsh niciraPushNsh() {
        return OFActionNiciraPushNshVer15.INSTANCE;
    }
    ...
    public OFActionNiciraSetQueue.Builder buildNiciraSetQueue() {
        return new OFActionNiciraSetQueueVer15.Builder();
    }
    public OFActionNiciraSetQueue niciraSetQueue(long queueId) {
        return new OFActionNiciraSetQueueVer15(
                queueId
                    );
    }
    ...
    public OFActionNiciraCt.Builder buildNiciraCt() {
        throw new UnsupportedOperationException("OFActionNiciraCt not supported in version 1.5");
    }

    public OFActionNiciraCtClear niciraCtClear() {
        throw new UnsupportedOperationException("OFActionNiciraCtClear not supported in version 1.5");
    }

    public OFActionNiciraNat.Builder buildNiciraNat() {
        throw new UnsupportedOperationException("OFActionNiciraNat not supported in version 1.5");
    }
    ...
    public OFActionCircuit.Builder buildCircuit() {
        throw new UnsupportedOperationException("OFActionCircuit not supported in version 1.5");
    }
    ...
    public OFActionOfdpaPopCw ofdpaPopCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPopCw not supported in version 1.5");
    }

    public OFActionOfdpaPopL2Header ofdpaPopL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPopL2Header not supported in version 1.5");
    }

    public OFActionOfdpaPushCw ofdpaPushCw() {
        throw new UnsupportedOperationException("OFActionOfdpaPushCw not supported in version 1.5");
    }

    public OFActionOfdpaPushL2Header ofdpaPushL2Header() {
        throw new UnsupportedOperationException("OFActionOfdpaPushL2Header not supported in version 1.5");
    }

    public OFActionOfdpaSetVlanTranslation ofdpaSetVlanTranslation() {
        throw new UnsupportedOperationException("OFActionOfdpaSetVlanTranslation not supported in version 1.5");
    }

    public OFActionOnfCopyField.Builder buildOnfCopyField() {
        throw new UnsupportedOperationException("OFActionOnfCopyField not supported in version 1.5");
    }

    public OFActionOplinkAtt.Builder buildOplinkAtt() {
        throw new UnsupportedOperationException("OFActionOplinkAtt not supported in version 1.5");
    }
